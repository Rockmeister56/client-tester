...
(function() {
    ...
    style.textContent = `
        ...
        .splash-service-line { color: #ffffff !important; font-size: 14px !important; margin-top: 10px !important; margin-bottom: 8px !important; } .splash-navy { background: linear-gradient(180deg, ${config.splashScreen?.gradientCenter || '#1e4a8a'} 0%, ${config.splashScreen?.gradientOuter || '#0a1a2f'} 75%, transparent 100%) !important; padding-bottom: 0px !important; } .ticker-container { position: relative !important; z-index: 2 !important; margin-bottom: 15px !important; } .button-group { background: transparent !important; padding: 0px 20px 20px 20px !important; margin: 0 !important; display: flex; flex-direction: column; align-items: center; gap: 10px !important; } 
        ...
        .secondary-btn { padding: 12px 15px !important; border-radius: 8px !important; border: none !important; font-size: 14px !important; font-weight: 600 !important; cursor: pointer; width: 90% !important; max-width: 320px !important; transition: transform 0.2s ease !important; } .secondary-btn:hover { transform: scale(1.03) !important; filter: brightness(1.1) !important; }
        .ticker-container {
