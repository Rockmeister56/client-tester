...
// Generated: 4/21/2026, 1:08:23 AM
...
(function() {
    ...
    style.textContent = `
        ...
        .button-group { display: flex; gap: 10px; justifyjustify-content: center; margin-top: 15px; }
    ...
    async function initDaily() {
        ...
        try {
            ...
            if (data.room_url && data.token) {
                ...
                // ===== 🎧 CLEAN AUDIO LISTENER (FIXED V5.9) =====
                dailyCallObject.on("app-message", (ev) => {
                    
                    // ✅ FIX 1: Interview Mode - Silence Default AI
                    ...
                    // ✅ FIX 3: TRIGGER LOGIC (Cleaned Up)
                    if (ev && ev.data) {
                        ...
                        // ✅ FIX 4: Ignore trigger if Dashboard started it
                        ...
                        if (cleanText.includes(cleanTrigger)) {
                            console.log("🔍 [SOURCE] Trigger detected via LOCAL Daily Listener");
    ...
    function forcePreQualification() {
        ...
        // 🔍 DIAGNOSTIC: Who called this function?
        console.trace("🔍 [TRACE] forcePreQualification was called from:");
