...
// Generated: 7/13/2026, 7:49:42 PM
        ...
        if (config.branding?.logo || config.branding?.name) {
           ...
           let pageHTML = logoHTML + `
            <div class="splash-navy">
                ...
                <div class="splash-service-line">${config.serviceLine || 'Offering 24/7 Friendly Customer Service!'}</div>
            </div>
        `;
